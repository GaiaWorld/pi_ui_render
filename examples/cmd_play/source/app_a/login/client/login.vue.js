_$pi.define("app_a/login/client/login.vue", ["require", "exports", "module", "pi_gui/widget/direct", "./login.vue.tpl", "pi_gui/widget/direct", "pi_common/ui/tools", "pi_common/sso/sso_client", "app_a/util/setup", "pi_utils/res/sound", "pi_common/ui/main_root", "pi_utils/util/logger", "./register.vue", "app_a/widget/tips/tips.vue", "pi_sys/index"], function (require, exports, module, direct_1, login_vue_tpl_1, direct_2, tools_1, sso_client_1, setup_1, sound_1, main_root_1, logger_1, register_vue_1, tips_vue_1, index_1) {
    "use strict";
    ...
    class Login {
        ...
        payTest() {
            ...
            index_1.PISYS.Native.Pay.pay(sdkName, payInfo).then(r => {
                logI("支付成功", r);
            }).catch(e => {
                logE("支付失败", e);
            });
        ...
        doLogin(loginType) {
            switch (loginType) {
                ...
                case sso_client_1.LoginType.GOOGLE:
                case sso_client_1.LoginType.FACEBOOK:
                case sso_client_1.LoginType.WX_MINIGAME:
                case sso_client_1.LoginType.QQ_GAME:
                    setup_1.Global.sdk.login.login({
                        loginType
                    });
                    break;

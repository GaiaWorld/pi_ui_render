...
impl Example for QuadExample {
    fn init(&mut self, mut world: Param, size: (usize, usize)) {
        ...
        world.user_cmd.set_style(div2, WidthType(Dimension::Points(500.0)));
        ...
        world.user_cmd
            .set_style(div2, BackgroundImageType(Atom::from("examples/z_source/moon.jpg")));
		world.user_cmd
        ...
        world.user_cmd.set_style(div2, BorderRadiusType(BorderRadius {
            x: [LengthUnit::Pixel(40.0), LengthUnit::Pixel(40.0), LengthUnit::Pixel(40.0), LengthUnit::Pixel(40.0)],
            y: [LengthUnit::Pixel(40.0), LengthUnit::Pixel(40.0), LengthUnit::Pixel(40.0), LengthUnit::Pixel(40.0)],
        }));

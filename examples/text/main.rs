...
use pi_style::{
    style::{Aabb2, ColorAndPosition, LinearGradientColor, Point2, TextContent, TransformFunc},
    style_type::{
        ...
        PositionTypeType, TextContentType, TransformFuncType, TransformType, WidthType,
    },
};
...
impl Example for QuadExample {
    fn init(&mut self, world: &mut World, size: (usize, usize)) {
        ...
        transform
            .all_transform
            .transform
            .push(TransformFunc::TranslateX(pi_style::style::LengthUnit::Percent(-0.5))); // 旋转45度

...
use pi_null::Null;
use pi_style::{
    style::{Aabb2, BorderImageSlice, BorderRadius, ImageRepeatOption, LengthUnit, Point2},
    style_type::{
        AsImageType, BorderBottomType, BorderImageRepeatType, BorderImageSliceType, BorderImageType, BorderLeftType, BorderRadiusType, BorderRightType, BorderTopType, FlexWrapType, HeightType, MarginLeftType, MarginTopType, PositionLeftType, PositionTopType, PositionTypeType, WidthType
    },
};
use pi_ui_render::{
    components::{
...
impl Example for QuadExample {
    fn init(&mut self, mut world: Param, size: (usize, usize)) {
        ...
        world.user_cmd.push_cmd(NodeCmd(ClearColor(CgColor::new(0.0, 0.0, 0.0, 0.0), true), root));
        ...
        world.user_cmd.set_style(div2, WidthType(Dimension::Points(120.0)));
        world.user_cmd.set_style(div2, HeightType(Dimension::Points(120.0)));
        ...
        world.user_cmd.set_style(div3, WidthType(Dimension::Points(140.0)));
        world.user_cmd.set_style(div3, HeightType(Dimension::Points(140.0)));
        ...
        world.user_cmd.set_style(div4, HeightType(Dimension::Points(140.0)));
        ...
        world.user_cmd.set_style(div5, HeightType(Dimension::Points(140.0)));
        ...
        world.user_cmd.set_style(div2, PositionTypeType(PositionType::Relative));
        world.user_cmd
            .set_style(div2, BorderImageType(Atom::from("examples/z_source/moon.jpg")));
        world.user_cmd.set_style(
            div2,
            BorderImageSliceType(BorderImageSlice {
                top: unsafe { NotNan::new_unchecked(0.33333) },
        ...
        world.user_cmd.set_style(div2, BorderRadiusType(BorderRadius {
            x: [LengthUnit::Pixel(30.0), LengthUnit::Pixel(30.0), LengthUnit::Pixel(30.0), LengthUnit::Pixel(30.0)],
            y: [LengthUnit::Pixel(30.0), LengthUnit::Pixel(30.0), LengthUnit::Pixel(30.0), LengthUnit::Pixel(30.0)],
        }));
        world.user_cmd.append(div2, root);
    }

...
impl Example for QuadExample {
    fn init(&mut self, mut world: Param, size: (usize, usize)) {
        ...
        // self.cmd.set_style(div10, WidthType(Dimension::Points(448.0)));
        // self.cmd.set_style(div10, HeightType(Dimension::Points(62.0)));
        // self.cmd.set_style(div10, PositionTypeType(PositionType::Relative));
        // self.cmd.set_style(
        //     div10,
        //     BorderImageType(Atom::from("examples/border_image/source/chuangjianjuese_shuxingbg.png")),
        // );
        ...
        //     }),
        // );
        // self.cmd.set_style(div10, BorderTopType(Dimension::Points(0.0)));
        // self.cmd.set_style(div10, BorderRightType(Dimension::Points(200.0)));
        // self.cmd.set_style(div10, BorderBottomType(Dimension::Points(0.0)));
        // self.cmd.set_style(div10, BorderLeftType(Dimension::Points(200.0)));

...
impl Example for QuadExample {
    async fn init(
		...
		gui.gui.set_style(div1, BorderImageType (BorderImage(Atom::from("examples/border_image/source/dialog_bg.png") )));
		gui.gui.set_style(div1, BorderImageSliceType(BorderImageSlice {
		...
		gui.gui.set_style(div1, BorderImageRepeatType (BorderImageRepeat (BorderImageRepeatOption::Repeat, BorderImageRepeatOption::Repeat)));

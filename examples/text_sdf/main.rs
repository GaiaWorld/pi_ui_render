...
//         world.user_cmd.set_style(div1, FontFamilyType(Atom::from("hwxw")));
// 		  world.user_cmd.set_style(div1, pi_style::style_type::TextStrokeType(pi_style::style::Stroke {
...
//         world.user_cmd.set_style(div2, FontFamilyType(Atom::from(""))); // 测试使用默认文字的情况
...
//         world.user_cmd.set_style(div3, PositionTopType(Dimension::Points(70.0)));
//         world.user_cmd.set_style(div3, PositionLeftType(Dimension::Points(70.0)));
//         world.user_cmd
//             .set_style(div3, TextContentType(TextContent("庆".to_string(), Atom::from("庆"))));
    
//         // rgb(255,0,0) 0px 0px 5px, rgb(255,0,0) 0px 0px 3px, rgb(255,255,255) 0px 0px 1px;
//         world.user_cmd.set_style(div3, FontFamilyType(Atom::from("hwxw")));

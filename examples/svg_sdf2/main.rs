...
use pi_ui_render::{
    ...
    resource::{NodeCmd, Shape, SvgColorCmd, SvgShapeCmd, UserCommands, StrokeDasharrayCmd, SvgStrokeColorCmd, SvgStrokeWidthCmd, SvgShapeWidthCmd, SvgShapeHeightCmd, SvgShapeXCmd, SvgShapeYCmd, SvgWidthCmd, SvgHeightCmd},
};
use pi_style::{
...
impl Example for QuadExample {
    ...
    fn init(&mut self, world: &mut World, size: (usize, usize)) {
        ...
        self.cmd.push_cmd(SvgWidthCmd(div1, 100.0));
        self.cmd.push_cmd(SvgHeightCmd(div1, 100.0));
        ...
        self.cmd.push_cmd(SvgStrokeColorCmd(div1, CgColor::new(0., 0., 0., 1.)));
        self.cmd.push_cmd(SvgStrokeWidthCmd(div1, NotNan::new(2.0).unwrap()));

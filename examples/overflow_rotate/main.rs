...
impl Example for QuadExample {
    fn init(&mut self, mut world: Param, size: (usize, usize)) {
        ...
        // world.user_cmd.set_style(div1, OverflowType(Overflow(true)));
        ...
        // world.user_cmd.set_style(div1, TransformWillChangeType(transform.funcs));
        ...
        world.user_cmd.set_style(div3, WidthType(Dimension::Points(250.0)));
        ...
        world.user_cmd.set_style(div3, OverflowType(true));
        ...
        world.user_cmd.set_style(div5, PositionTypeType(PositionType::Absolute));
        world.user_cmd.set_style(div5, PositionLeftType(Dimension::Points(50.0)));
        ...
        world.user_cmd.set_style(div6, PositionTypeType(PositionType::Absolute));
        world.user_cmd.set_style(div6, PositionLeftType(Dimension::Points(100.0)));
        world.user_cmd.set_style(div6, PositionTopType(Dimension::Points(100.0)));
        ...
        // 设置opacity，测试Pass2d在父上存在TransformWillChange的情况下能否正确渲染
        world.user_cmd.set_style(div6, OpacityType(0.5));
        let mut transform = Transform::default();
        transform.all_transform.transform.push(TransformFunc::RotateZ(30.0)); // 旋转30度
        world.user_cmd.set_style(div6, TransformType(transform.all_transform.transform));
        world.user_cmd.append(div6, div3);

        // 添加一个绿色四边形，设置oveflow为true，
        let div7 = world.spawn(NodeTag::Div);
        world.user_cmd.set_style(div7, PositionTypeType(PositionType::Absolute));
        world.user_cmd.set_style(div7, PositionLeftType(Dimension::Points(150.0)));
        world.user_cmd.set_style(div7, PositionTopType(Dimension::Points(100.0)));
        world.user_cmd.set_style(div7, WidthType(Dimension::Points(50.0)));
        world.user_cmd.set_style(div7, HeightType(Dimension::Points(50.0)));
        world.user_cmd
            .set_style(div7, BackgroundColorType(Color::RGBA(CgColor::new(0.0, 1.0, 0.0, 1.0))));
        world.user_cmd.set_style(div7, OverflowType(true));
        let mut transform = Transform::default();
        transform.all_transform.transform.push(TransformFunc::RotateZ(30.0)); // 旋转30度
        world.user_cmd.set_style(div7, TransformType(transform.all_transform.transform));
        world.user_cmd.append(div7, div3);

        // 添加一个黄色四边形，设置旋转，
        let div8 = world.spawn(NodeTag::Div);
        world.user_cmd.set_style(div8, PositionTypeType(PositionType::Absolute));
        world.user_cmd.set_style(div8, PositionLeftType(Dimension::Points(15.0)));
        world.user_cmd.set_style(div8, WidthType(Dimension::Points(50.0)));
        world.user_cmd.set_style(div8, HeightType(Dimension::Points(50.0)));
        world.user_cmd
            .set_style(div8, BackgroundColorType(Color::RGBA(CgColor::new(1.0, 1.0, 0.0, 1.0))));
        let mut transform = Transform::default();
        transform.all_transform.transform.push(TransformFunc::RotateZ(45.0)); // 旋转45度
        world.user_cmd.set_style(div8, TransformType(transform.all_transform.transform));
        world.user_cmd.append(div8, div7);
    }

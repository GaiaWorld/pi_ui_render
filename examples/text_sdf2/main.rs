...
use pi_style::{
    style::{Aabb2, ColorAndPosition, FontStyle, LinearGradientColor, Point2, Stroke, TextContent, TextOverflow, TextShadow, TransformFunc},
    style_type::{
        AsImageType, BackgroundColorType, ColorType, FlexWrapType, FontFamilyType, FontSizeType, FontStyleType, FontWeightType, HeightType, MarginLeftType, MarginTopType, OverflowWrapType, PositionLeftType, PositionTopType, PositionTypeType, TextContentType, TextOverflowType, TextShadowType, TextStrokeType, TransformType, WidthType
    },
};
...
impl Example for QuadExample {
    fn init(&mut self, world: &mut World, size: (usize, usize)) {
        ...
        self.cmd
            .set_style(div10, TextContentType(TextContent("放".to_string(), Atom::from("放"))));

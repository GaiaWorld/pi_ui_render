...
layout(set = 3, binding = 0) uniform sampler index_tex_samp;
layout(set = 3, binding = 1) uniform texture2D u_index_tex;

layout(set = 4, binding = 0) uniform sampler data_tex_samp;
layout(set = 4, binding = 1) uniform texture2D u_data_tex;
// (网格的边界-宽, 网格的边界-高, z, w)

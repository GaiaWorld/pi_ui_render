...
use crate::resource::draw_obj::{CommonSampler, EmptyVertexBuffer, ProgramMetaRes, TextTextureGroup};
...
// };
use crate::components::{calc::DrawList, draw_obj::DrawState, user::Color};

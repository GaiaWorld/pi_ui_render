...
use pi_ecs::prelude::{Query, Write, filter_change::Changed, OrDefault};
use pi_ecs_utils::prelude::{LayerDirty, Layer, NodeUp};
...
pub fn calc_show(
	dirty: &LayerDirty<Node, (Changed<Layer>, Changed<Show>)>,
	query: Query<Node, (OrDefault<Show>, Option<&NodeUp>)>,

...
use pi_render::rhi::{
	...
	bind_group_layout::BindGroupLayout, dyn_uniform_buffer::Group
};
use pi_share::Share;

use crate::{
	resource::draw_obj::{
		StateMap, Shaders, VertexBufferLayoutMap, ShareLayout, ShaderCatch, ShaderMap, Program, VertexBufferLayout, VertexBufferLayouts, DynBindGroupLayout, ShaderStatic, StaticIndex, TextStaticIndex, CommonPipelineState}, 
	components::draw_obj::{VSDefines, FSDefines}, shaders::{color::CameraMatrixGroup, text::{TextMaterialGroup, SampTex2DGroup}}
};

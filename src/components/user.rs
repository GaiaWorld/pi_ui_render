...
pub mod serialize {
    ...
    impl StyleAttr {
        ...
        pub fn push_component_ops(style_index: u16, components: &SettingComponentIds, arr: &mut Vec<(ComponentIndex, bool)>) {
            if style_index > STYLE_COUNT {
                ...
                let r = if style_index >= 97 {
                    (SVGTYPE_ATTR[(style_index - 97) as usize].push_component_ops)(components, arr)
                } else {
        ...
        pub fn size(style_index: u16) -> usize {
            if style_index > STYLE_COUNT {
                ...
                let r = if style_index >= 97 {
                    (SVGTYPE_ATTR[(style_index - 97) as usize].size)()
                } else {
    ...
    pub const SCG_STYLE_START: usize = 97;
